import { pgTable, foreignKey, serial, integer, varchar, timestamp, unique, boolean, date, numeric, text, time, pgEnum } from "drizzle-orm/pg-core"
...
export const subjectStatus = pgEnum("subject_status", ['PASS', 'FAIL'])
...
export const courses = pgTable("courses", {
	...
	foreignKey({
			columns: [table.streamIdFk],
			foreignColumns: [streams.id],
			name: "courses_stream_id_fk_streams_id_fk"
		}),
]);
